...
To **train the AAM**, the "Annotation" folder is a manually labeled image of the auroral area;&ensp;v to **train the ASM**, the "Annotation" folder is the generated AuroSS pseudo-labels. &ensp;Then run:<br>
